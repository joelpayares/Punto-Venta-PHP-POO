...
echo "<td><a href='ModificarPersona.php?id=".$row['idpersona']." ' class='btn btn-success btn-sm' name='Modifica' data-toggle='modal'/><span class='glyphicon glyphicon-edit'/></span> Editar</a></td>";

echo "<td><a href='EliminarPersona.php?id=".$row['idpersona']." ' class='btn btn-danger btn-sm' data-toggle='modal'/><span class='glyphicon glyphicon-trash'/></span> Eliminar</a></td>";

 echo "<td><a href='VerPersona.php?id=".$row['idpersona']." ' class='btn btn-success btn-sm' style='color: white;' data-toggle='modal'/>
