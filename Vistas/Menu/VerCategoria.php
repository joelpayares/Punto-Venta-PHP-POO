                   ...
                   <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" readonly="readonly" name="nombre" id="nombre" value="<?php echo $resultados[1]; ?> " maxlength="50" placeholder="Ingrese Nombre Categoria" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Descripción:</label>
                            <input type="text" class="form-control" readonly="readonly" name="descripcion" id="descripcion" value="<?php echo $resultados[2]; ?> " maxlength="256" placeholder="Descripción">
                          </div>
                          <br>
						  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <button class="btn btn-edit" type="button"><a href="EditarCategoria.php" class="fa fa-arrow-circle-left">Atras</button></a>
                          </div>
                        </form>
